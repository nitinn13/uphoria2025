...
const RightFlowersParallax: React.FC = () => {
  ...
  const topFlowerPosition = -scrollPosition * 0.5;
  const bottomFlowerPosition = scrollPosition * 0.1;

  return (
    <div className="fixed right-[-5vw] top-0 w-[12vw] h-screen pointer-events-none z-0">
      <div
        className="absolute top-[40vh] w-3/4 transition-transform duration-100 ease-out"
        style={{
      ...
      <div
        className="absolute top-[60vh] w-[10vw] transition-transform duration-100 ease-out"
        style={{
